...
export const createCheckOutSession = async (req,res)=>{
    try {
        ...
        const lineItems = products.map(product=>{
            const amount = Math.round(product.price * 100)  // stripe wants to send in the form of cents
        ...
        res.status(500).json({error : "while creating a check out session "+ error.message})
    }
}
